                                                ...
                                                <table class="rnb-col-1" cellspacing="0" cellpadding="0" border="0" align="center">
                                                    ...
                                                    <tr>
                                                        <td style="font-family:'Arial',Helvetica,sans-serif; color:#3c4858; text-align:center;">
                                                            ...
                                                            <span style="color:#3c4858;"><strong><span style="font-size:24px;">Russian Residence Permit</span></strong></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10"></td>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table valign="top" class="rnb-col-1" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div>Thank you for reaching out to Expatriant regarding residence permits in Russia.<br>
<br>
If you need personalized advice on applying for a residence permit in Russia, we have a consulting service available and <strong>the cost is $50 for 30 minutes</strong>. We will spend 30min discussing your specific circumstance and detail the options available.</div>
</td>
                                                                </tr>
                                                                </tbody></table>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table valign="top" class="rnb-col-1" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div>Before the call we will have you fill out a form so we can come prepared with all of the options that are potentially available to you. After the call, if you are interested in applying for a residence permit in Russia, we will put you in touch with a verified lawyer in Moscow.</div>
</td>
                                                                </tr>
                                                                </tbody></table>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table valign="top" class="rnb-col-1" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div>Keep in mind that legal <strong>assistance with your residence permit application is $1200</strong> and it includes the following:
<ul>
	<li>Consultation with a verified, English speaking lawyer in Moscow at each step in the process</li>
	<li>Completion of the application on your behalf</li>
	<li>Notarization and translation of all required documents</li>
	<li>Accompaniment to the interview at the immigration center and consultation during the interview</li>
	<li>Accompaniment to pick up the complete residence permit at the immigration center</li>
</ul>
<br>
This service is hands-off, you simply provide the documents and we handle the rest.<br>
<br>
Not included in the application cost:
<ul>
	<li>State application fee - 5,000 RUB</li>
	<li>Medical exam - 3,500 RUB</li>
	<li>Notary and translation services - 5,000 RUB</li>
</ul>
</div>
</td>
                                                                </tr>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table valign="top" class="rnb-col-1" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div><strong>Have you read through our posts on residency in Russia? </strong>

<ul>
	<li><a href="https://expatriant.com/can-i-get-a-residence-permit-as-a-student-in-russia/" style="text-decoration: underline; color: rgb(0, 146, 255);">Residency as a student</a></li>
	<li><a href="https://expatriant.com/can-i-get-a-residence-permit-by-working-in-russia/" style="text-decoration: underline; color: rgb(0, 146, 255);">Residency as an employee</a></li>
	<li><a href="https://expatriant.com/can-i-get-a-residence-permit-in-russia-if-i-have-a-russian-child/" style="text-decoration: underline; color: rgb(0, 146, 255);">I have a russian child</a></li>
	<li><a href="https://expatriant.com/legal-residence-in-russia-the-ultimate-guide/" style="text-decoration: underline; color: rgb(0, 146, 255);">Legal residence in Russia</a></li>
	<li><a href="https://expatriant.com/everything-you-need-to-know-about-temporary-residence-permits-in-russia/" style="text-decoration: underline; color: rgb(0, 146, 255);">Everything you need to know about temporary residency</a></li>
</ul>
</div>
</td>
                                                                </tr>
